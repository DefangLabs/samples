...
| [Mastra Server](./samples/mastra-server) | Self-host the Mastra agent server and Studio UI with managed PostgreSQL and a managed model, as an alternative to the Mastra Helm chart. | Mastra, AI, Agents, PostgreSQL, Studio, Self-Hosted, Kubernetes-Alternative | nodejs, TypeScript |
