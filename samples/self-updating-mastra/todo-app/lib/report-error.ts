...
//
// Note: the coding agent edits an isolated git worktree and its changes only
// reach this live app as a single atomic fast-forward after they typecheck (see
// agent/src/git.ts), so mid-run partial states never render here — there is no
// transient-error flood to suppress.
