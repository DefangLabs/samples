...
[![1-click-deploy](https://raw.githubusercontent.com/DefangLabs/defang-assets/main/Logos/Buttons/SVG/deploy-with-defang.svg)](https://portal.defang.io/sample/python-openai)
...
Tags: Python, Flask, OpenAI, AI, Python, sample
