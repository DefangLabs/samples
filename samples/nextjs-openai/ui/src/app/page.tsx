...
function Message({
  ...
  return (
    <div className={`chat ${isBot ? 'chat-start' : 'chat-end'}`}>
      <div className={`chat-bubble ${isBot ? 'bg-slate-900' : 'bg-yellow-800'} shadow-xl text-white`}>
    ...
    return [
      {
        role: 'assistant',
        content: (
          `Hi! I'm Defang, a fun chatbot with an interest in cloud computing. If you want to learn more about the Defang tool, then head to https://docs.defang.io/. `
        ),
      },
      ...messages
    ];
          ...
          <div className="fixed bottom-0 left-0 right-0 z-10">
            ...
            >
              ...
              <div className='flex flex-col justify-end'>
                <button className="p-4 bg-yellow-800 rounded-xl text-white shadow-xl hover:shadow-2xl transition-all h-auto" disabled={isLoading}>
                  {isLoading ? (
